export type HernessUIType = 'screen' | 'container' | 'card' | 'form' | 'table' | 'grid' | 'button' | 'input' | 'textarea' | 'select' | 'checkbox' | 'radio' | 'switch' | 'heading' | 'paragraph' | 'label' | 'link' | 'text' | 'image' | 'icon' | 'divider' | 'spacer' | 'avatar' | 'badge' | 'tag' | 'navbar' | 'sidebar' | 'footer' | 'menu' | 'tabs' | 'list' | 'list_item' | 'dropdown' | 'modal' | 'tooltip';
...
export type OctoNodeType = 'RECTANGLE' | 'TEXT' | 'LINE' | 'VECTOR' | 'FRAME' | 'GROUP' | 'IMAGE' | 'ELLIPSE' | 'POLYGON' | 'STAR' | 'COMPONENT' | 'INSTANCE' | 'SLICE' | 'CANVAS' | 'DOCUMENT';
