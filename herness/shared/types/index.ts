...
export interface RegressionReport {
  ...
  allPassed: boolean
  failures: Array<{ feature: string; detail: string }>
}
...
export interface VictoryVerdict {
  ...
  designCoverage: { totalSections: number; covered: number; missing: string[] }
  edgeCasesChecked: string[]
  minimumBarResults: Array<{ rule: string; satisfied: boolean }>
...
export interface VerificationResult {
  ...
  failures: Array<{ check: string; detail: string; severity: VerificationSeverity }>
  durationMs: number
  aborted: boolean
}
...
export interface ParallelVerificationReport {
  ...
  failures: Array<{ type: VerificationType; check: string; detail: string }>
}
...
export interface Checkpoint {
  ...
  operation: string
  featureName: string
  files: Array<{ originalPath: string; snapshotPath: string; size: number }>
