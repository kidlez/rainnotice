...
namespace winrt::impl
{
    ...
    {
        WINRT_IMPL_AUTO(void) Initialize(param::hstring const& clientAppUserModelId, uint32_t clientProcessId, param::hstring const& serverIdentity, param::hstring const& serverName, uint32_t serverProcessId) const;
        WINRT_IMPL_AUTO(void) OnMessage(param::hstring const& message, winrt::Windows::AI::Agents::Mcp::McpMessageDirection const& direction, winrt::Windows::AI::Agents::Mcp::McpMessageFilterResponse const& filterResponse) const;
    };
    ...
    {
        [[nodiscard]] WINRT_IMPL_AUTO(bool) IsAllowed() const;
        WINRT_IMPL_AUTO(void) IsAllowed(bool value) const;
        [[nodiscard]] WINRT_IMPL_AUTO(hstring) MessageIfNotAllowed() const;
        WINRT_IMPL_AUTO(void) MessageIfNotAllowed(param::hstring const& value) const;
    };
    ...
    struct consume_Windows_AI_Agents_Mcp_IMcpMessageFilterResponseExperimental2
    {
        ...
        WINRT_IMPL_AUTO(void) Reject(param::hstring const& reason) const;
    };
