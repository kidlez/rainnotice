...
namespace winrt::impl
{
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Devices::Haptics::HapticDeviceType) consume_Windows_Devices_Haptics_IInputHapticsManager<D>::CurrentHapticsControllerDeviceType() const
    {
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Devices::Haptics::SimpleHapticsController) consume_Windows_Devices_Haptics_IInputHapticsManager<D>::CurrentHapticsController() const
    {
        void* value{};
    ...
    template <typename D> WINRT_IMPL_AUTO(bool) consume_Windows_Devices_Haptics_IInputHapticsManager<D>::TrySendHapticWaveform(uint16_t waveform, uint16_t waveformFallback) const
    {
        bool result{};
    ...
    template <typename D> WINRT_IMPL_AUTO(bool) consume_Windows_Devices_Haptics_IInputHapticsManager<D>::TrySendHapticWaveform(uint16_t waveform, uint16_t waveformFallback, double intensity) const
    {
        bool result{};
    ...
    template <typename D> WINRT_IMPL_AUTO(bool) consume_Windows_Devices_Haptics_IInputHapticsManager<D>::TrySendHapticWaveformForDuration(uint16_t waveform, uint16_t waveformFallback, double intensity, winrt::Windows::Foundation::TimeSpan const& playDuration) const
    {
        bool result{};
    ...
    template <typename D> WINRT_IMPL_AUTO(bool) consume_Windows_Devices_Haptics_IInputHapticsManager<D>::TrySendHapticWaveformForPlayCount(uint16_t waveform, uint16_t waveformFallback, double intensity, int32_t playCount, winrt::Windows::Foundation::TimeSpan const& replayPauseInterval) const
    {
        bool result{};
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Devices::Haptics::HapticsControllerOverrideToken) consume_Windows_Devices_Haptics_IInputHapticsManager<D>::SetOverrideHapticsController(winrt::Windows::Devices::Haptics::HapticDeviceType const& deviceType, winrt::Windows::Devices::Haptics::SimpleHapticsController const& controller) const
    {
    ...
    template <typename D> WINRT_IMPL_AUTO(void) consume_Windows_Devices_Haptics_IInputHapticsManager<D>::ClearOverrideHapticsController(winrt::Windows::Devices::Haptics::HapticsControllerOverrideToken const& token) const
    {
    ...
    template <typename D> WINRT_IMPL_AUTO(bool) consume_Windows_Devices_Haptics_IInputHapticsManagerStatics<D>::IsHapticDevicePresent() const
    {
        bool result{};
        check_hresult(WINRT_IMPL_SHIM(winrt::Windows::Devices::Haptics::IInputHapticsManagerStatics)->IsHapticDevicePresent(&result));
        return result;
    }
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Devices::Haptics::InputHapticsManager) consume_Windows_Devices_Haptics_IInputHapticsManagerStatics<D>::GetForCurrentThread() const
    {
        void* result{};
    ...
    template <typename D> WINRT_IMPL_AUTO(winrt::Windows::Devices::Haptics::InputHapticsManager) consume_Windows_Devices_Haptics_IInputHapticsManagerStatics<D>::TryGetForThread(uint32_t ThreadId) const
    {
        void* result{};
